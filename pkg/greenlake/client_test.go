...
// 	}{
// 		{
// 			name: "Get token all inputs are provided",
// 			fields: Client{
// 				GrantType:    "foo",
// 				ClientID:     "foo",
// 				ClientSecret: "foo",
...
// 			got, err := c.GetToken()
// 			if err != nil {
// 				logger.Debug("unable to get the token with the supplied credentials: %v anf got %v", err, got)
// 			}
...
// 	}{
// 		{
// 			name: "Get users all inputs are provided",
// 			fields: Client{
// 				GrantType:    "foo",
// 				ClientID:     "cli",
// 				ClientSecret: "key",
...
// 			got, err := c.GetUsers(tt.args.path)
...
// 			if status := rr.Code; status != http.StatusOK {
// 				t.Errorf(handlerWrongStatusCode, status, http.StatusOK)
...
// 	req1, _ := http.NewRequest(http.MethodPost, host+"/identity/v1/token", nil)
// 	req2, _ := http.NewRequest(http.MethodGet, host+"/scim/v1/tenant/ten/Users", nil)
// 	type args struct {
// 		req  *http.Request
